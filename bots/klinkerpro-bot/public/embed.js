(function () {
  ...
  function mount() {
    ...
    var ICON_HOME =
      '<svg class="kpb-btn-home" width="28" height="28" viewBox="0 0 24 24" fill="none" aria-hidden="true">' +
    ...
    /** Кнопка виджета: 200×60 px, right 60 / bottom 100 (см. pinFab) */
    var FAB_WIDTH_PX = 200;
