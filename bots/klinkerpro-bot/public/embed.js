(function () {
  ...
  function mount() {
    ...
    style.textContent = [
      ...
      '#kpb-head .kpb-head-mascot{display:block;width:34px;height:34px;object-fit:contain;object-position:center}',
