(function () {
  ...
  function mount() {
    ...
    style.textContent = [
      ...
      '#kpb-root #kpb-head a.kpb-head-phone.kpb-tel{text-decoration:none !important;color:#fff !important;font-weight:700;background:#d54d00;border-radius:10px;padding:8px 14px;line-height:1.2;box-shadow:0 2px 6px rgba(0,0,0,.12)}',
