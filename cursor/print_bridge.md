...
**23.08.2026 — агентам РК печать не нужна.** Word только в `cursor/`, ссылка в чат. Не вызывать `queue_print.py`, не класть файлы в `inbox/`. Правило: `cursor/RK_agents_conventions.md`.
