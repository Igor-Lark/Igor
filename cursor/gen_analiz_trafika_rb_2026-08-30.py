...
def build():
    ...
    add_bullets(
        ...
        [
            ...
            "G10 забрал 44% показов — основной драйвер; G11 запущен (104 п). **G12 не планируется** — пеламида в G5.",
            ...
            "G5: пеламида **остаётся** в G5; в G5 добавить минусы −луфарь (чтобы не мешать G11).",
        ],
        color=RED,
    )
    ...
    add_bullets(
        ...
        [
            ...
            "G5: пеламида в заголовках — **норма** (G12 отменена). Добавить −луфарь в минусы G5.",
    ...
    add_bullets(
        ...
        [
            ...
            "☐ G5: минусы −луфарь · пеламида **остаётся** (G12 не заводим)",
