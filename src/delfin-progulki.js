...
const MORNING_DELFIN_CHARTER_RE =
  /(?:\/delfin|delfin\b|утр[а-яё]*\s+(?:к\s+)?дельфин|аренд[а-яё]*\s+катер[а-яё]*\s+(?:к\s+)?дельфин|катер\s+«?сириус»?\s+(?:к\s+)?дельфин|индивиду[а-яё]*\s+(?:к\s+)?дельфин|7500|7\s*500.*(?:дельфин|утр)|утренн[а-яё]*\s+аренд[а-яё]*\s+катер|дельфин[а-яё]*.*утр[а-яё]*\s+аренд)/i;
