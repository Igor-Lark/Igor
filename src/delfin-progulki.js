...
const GROUP_SAILING_RE =
  /группов[а-яё]*|билет|1\s*[,.]\s*5\s*час|1800|1\s*800|progulki|progulki_na_yacht|парусн[а-яё]*\s+прогул|место\s+на\s+(?:яхт|парус)|рейс\s+на\s+закат|2500|2\s*500.*закат/i;
