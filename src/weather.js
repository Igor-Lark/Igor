...
const FORECAST_DAYS_RE =
  /ближайш\w*\s+(\d+\s+)?дн|на\s+(1|2|3|один|два|три)\s+дн|через\s+(день|два|три)|прогноз\s+на\s+(завтра|послезавтра)|погода\s+на\s+(завтра|послезавтра)|на\s+завтра|на\s+послезавтра/i;
