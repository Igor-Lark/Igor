...
- **Когда MAX для заявок стабильно работает** — убрать из ответов бота ссылку `#bot` / фразу про заявку на обратный звонок на сайте и **удалить соответствующие блоки формы на Тильде**. Напомнить в чате: «убери #bot и блоки Тильды».
