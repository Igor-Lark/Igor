(function () {
  ...
  function mount() {
    ...
    style.textContent = [
      ...
      '#bsb-btn{all:initial;position:fixed !important;right:16px !important;bottom:20px !important;min-width:56px !important;height:56px !important;border:2px solid rgba(239,31,31,.2) !important;border-radius:5px !important;cursor:pointer;background:rgba(32,67,96,.2) !important;color:#fff !important;line-height:1.05 !important;box-shadow:0 8px 24px rgba(32,67,96,.08);display:flex !important;flex-direction:column !important;align-items:center;justify-content:center;gap:2px;visibility:visible !important;opacity:1 !important;pointer-events:auto !important;z-index:2147483001 !important;padding:6px 12px !important;margin:0 !important;transform:none !important;transition:none !important;font-family:Segoe UI,Roboto,Helvetica,Arial,sans-serif !important;box-sizing:border-box !important;-webkit-tap-highlight-color:transparent}',
      ...
      '#bsb-btn:hover{background:rgba(24,52,76,.2) !important}',
      ...
      '#bsb-panel{position:absolute;top:auto;right:0;bottom:0;height:75vh;max-height:75vh;width:min(600px,100vw);max-width:100vw;background:rgba(255,255,255,.2);border:1px solid rgba(226,232,240,.2);display:flex;flex-direction:column;box-shadow:-12px 0 40px rgba(15,23,42,.08);transform:translateX(105%);transition:transform .28s ease;pointer-events:auto;z-index:3;border-radius:5px 0 0 0;overflow:hidden}',
      '#bsb-panel.open{transform:translateX(0)}',
      '#bsb-head{--bsb-avatar:64px;position:relative;background:rgba(32,67,96,.2);color:#fff;min-height:96px;padding:12px 44px 12px 14px;display:flex;align-items:center;justify-content:flex-start;gap:12px;flex-shrink:0;flex-wrap:nowrap}',
      ...
      '#bsb-msgs{flex:1;overflow:auto;padding:14px;background:rgba(248,250,252,.2);display:flex;flex-direction:column;gap:10px;-webkit-overflow-scrolling:touch}',
      ...
      '.bsb-msg.bot{align-self:flex-start;background:rgba(255,255,255,.2);border:1px solid rgba(226,232,240,.2);color:#0f172a}',
      '.bsb-msg.user{align-self:flex-end;background:rgba(90,127,156,.2);border:1px solid rgba(90,127,156,.2);color:#fff;border-radius:20px}',
      ...
      '#bsb-form{display:flex;gap:8px;padding:10px 10px 40px;border-top:1px solid rgba(226,232,240,.2);background:rgba(255,255,255,.2);flex-shrink:0}',
      '#bsb-input{flex:1;border:1px solid rgba(203,213,225,.2);border-radius:5px;padding:10px 12px;font-size:14px;outline:none;background:rgba(255,255,255,.2);color:#0f172a}',
      '#bsb-input:focus{border-color:rgba(32,67,96,.2)}',
      '#bsb-send{border:1px solid rgba(32,67,96,.2);border-radius:5px;background:rgba(32,67,96,.2);color:#fff;padding:0 14px;font-size:14px;font-weight:600;cursor:pointer;display:flex;align-items:center;justify-content:center}',
